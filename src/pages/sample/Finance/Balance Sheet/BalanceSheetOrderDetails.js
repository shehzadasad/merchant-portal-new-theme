...
import OrderDetailsTable from 'pages/sample/Orders/OrderDetailsTable'
import { useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import { Link, useParams } from 'react-router-dom'
import { fetchOrderDetails } from 'redux/actions/OrderAction.js'
import BalanceSheetOrdersDetailsTable from './BalanceSheetOrderDetailsTable'
...
const BalanceSheetOrderDetails = () => {
  ...
  return (
    <Container>
      ...
      <BalanceSheetOrdersDetailsTable
...
export default BalanceSheetOrderDetails
