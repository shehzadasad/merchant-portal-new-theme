...
const BalanceSheetOrdersDetailsTable = (props) => {
  const { id } = useParams()
                            ...
                            <>
                              ...
                              {column.format === 'img' ? (
                                <img
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/balancesheet/order/item/details/${
                                        id && id
                                      }/${row['id']}`
                                    )
                                  }
...
export default BalanceSheetOrdersDetailsTable

BalanceSheetOrdersDetailsTable.propTypes = {
